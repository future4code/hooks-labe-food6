...
import { GreyBorderTextField, LoadingDiv, LoadingScreenDiv, LoginPageContentDiv, LoginPageFormDiv, LoginPageLogoDiv, LoginPageMainDiv ,SignUpButton} from './styled';
...
const LoginPage = () => {
    ...
    const handleClose = (event, reason) => {
     ...
     //mostrar por 2s antes de mostrar formulario de logIn
     return ( showLoadingScreen ? (<LoadingScreenDiv>
        <img alt='loading screen' src={openHome} /> 
    </LoadingScreenDiv>) :  
        ( 
        <LoginPageMainDiv>
